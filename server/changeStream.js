...
async function main() {
    ...
    const uri = `mongodb+srv://${process.env.MONGO_DB_USER_NAME}:${process.env.MONGO_DB_USER_PASSWORD}@cluster0.94wey.mongodb.net/companyDB?retryWrites=true&w=majority`;
    /**
